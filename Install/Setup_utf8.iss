...
japanese.ProgramIsRunning = Clam SentinelВЌНмУЃТЖВ≈ВЈ
japanese.PleaseCloseTheProgramFirst = Н≈ПЙВ…ГvГНГOГЙГАВрХ¬ВґВƒЙЇВ≥ВҐ
japanese.ClamWinNotInstalled = ClamWinВ™ГCГУГXГgБ[ГЛВ≥ВкВƒВҐВ№ВєВс
japanese.ClamWinIsRequired = Clam SentinelВћГCГУГXГgБ[ГЛВ…ВЌClamWinВ™ХKЧvВ≈ВЈ http://www.clamwin.com/
japanese.SetupWillTerminateNow = ГZГbГgГAГbГvВрПIЧєВµВ№ВЈ
japanese.AutostartKeyForAllUser = ВЈВ„ВƒВћГЖБ[ГUБ[В≈О©УЃУIВ…Clam SentinelВрЛNУЃВµВ№ВЈВ©БH
...
russian.ProgramIsRunning = ѕриложение Clam Sentinel запущено.
russian.PleaseCloseTheProgramFirst = «акройте приложение дл€ продолжени€ установки.
russian.ClamWinNotInstalled = ѕри установки обнаружено что ClamWin неустановлен.
russian.ClamWinIsRequired = ƒл€ Clam Sentinel требуетс€ установка ClamWin http://www.clamwin.com/
russian.SetupWillTerminateNow = ”становка сейчас будет завершена.
russian.AutostartKeyForAllUser = «апускать Clam Sentinel автоматически дл€ всех пользователей
...
bulgarian.ProgramIsRunning = ѕрограмата Clam Sentinel се стартира.
bulgarian.PleaseCloseTheProgramFirst = ћол€ затворете програмата първо.
bulgarian.ClamWinNotInstalled = ѕрограмата не открива ClamWin да е инсталиран.
bulgarian.ClamWinIsRequired = Clam Sentinel изисква инсталаци€ на  ClamWin http://www.clamwin.com/
bulgarian.SetupWillTerminateNow = »нсталаци€та ще бъде прекъсната сега.
bulgarian.AutostartKeyForAllUser = —тартирай Clam Sentinel автоматично за всички потребители.
...
;Source: "..\Описание.txt"; DestDir: "{app}"; Languages: russian; Flags: ignoreversion
